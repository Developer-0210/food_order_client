          ...
          <CardContent className="px-8 pb-8">
            ...
            <div className="mt-6 text-center">
              <p className="text-xs text-slate-500">
                By signing in, you agree to our terms of service and <Link href="/privacy" className="text-green-600">privacy policy</Link> and <Link href="/contact" className="text-green-600">contact us</Link>.
              </p>
            </div>
          </CardContent>
        </Card>
